...
public class PlayerCutsceneAbort extends GameEvent<PlayerCreature> {
	final public PlayerCreature player;

	public PlayerCutsceneAbort(GameObject actor) {
		super(actor);

		player = (PlayerCreature) NWScript.getLastPCToCancelCutscene();
	}
}
